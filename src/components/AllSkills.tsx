          ...
          <div className="max-w-md mx-auto mb-8">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-card border-2 border-primary/30 focus:border-primary text-center"
              />
            </div>
          </div>
                    ...
                    return (
                      ...
                      >
                        <CardHeader className="pb-3 relative z-10">
                          <div className="w-12 h-12 rounded-2xl bg-primary flex items-center justify-center mb-3 group-hover:scale-110 transition-all duration-300 shadow-glow">
