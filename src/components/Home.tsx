    ...
    <div className="min-h-screen bg-background relative">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl md:text-2xl font-bold flex items-center gap-2">
                <span className="text-foreground font-dot">GTA</span>
            ...
            <div className="hidden md:flex items-center flex-1 max-w-md mx-8 gap-2">
              <div className="relative w-full">
                ...
                <Input
                  ...
                  className="pl-10 bg-transparent border-2 focus:border-primary"
                  value={searchTerm}
              ...
              <select
                ...
                className="text-xs bg-transparent border-2 rounded-full px-2 py-2 text-muted-foreground focus:border-primary focus:outline-none"
              >
      ...
      <section className="py-8 md:py-16 px-4 relative overflow-hidden z-10">
        <div className="absolute inset-0 pointer-events-none">
          <div className="hidden md:block absolute top-20 left-10 w-2.5 h-2.5 rounded-full bg-primary animate-pulse" />
          <div className="absolute top-16 md:top-32 right-4 md:right-20 w-2 h-2 rounded-full bg-primary animate-pulse animation-delay-300" />
          <div className="hidden md:block absolute bottom-32 left-20 w-2 h-2 rounded-full bg-foreground/30" />
          <div className="absolute top-24 md:top-40 right-8 md:right-40 w-1.5 h-1.5 rounded-full bg-primary animate-pulse animation-delay-700" />
          <div className="absolute bottom-20 md:bottom-40 right-6 md:right-16 w-2 h-2 rounded-full bg-foreground/30" />
          <div className="hidden md:block absolute top-60 left-32 w-1.5 h-1.5 rounded-full bg-primary animate-pulse" />
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {skillCategories.map((category, index) => {
              ...
              return (
                <Card
                  key={category.name}
                  className="crystal-card group hover:scale-[1.02] transition-all duration-300 cursor-pointer relative"
                  onClick={() => handleCategoryClick(category.name)}
                >
                  <span className="font-dot absolute top-3 right-4 text-xs text-muted-foreground">
                    {String(index + 1).padStart(2, '0')}
                  </span>
                  <CardHeader className="pb-2 md:pb-3 relative z-10">
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl border-2 bg-transparent flex items-center justify-center mb-2 md:mb-3 group-hover:scale-110 transition-all duration-300 shadow-glow">
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {dbSkills.slice(0, 4).map((skill) => (
                  ...
                  >
                    <CardHeader className="pb-2 md:pb-3 relative z-10">
                      <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl border-2 bg-transparent flex items-center justify-center mb-2 md:mb-3 shadow-glow">
