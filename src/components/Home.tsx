    ...
    <div className="min-h-screen bg-background relative">
      ...
      <section className="py-8 md:py-16 px-4 relative overflow-hidden z-10">
        <div className="absolute inset-0 pointer-events-none">
          <div className="hidden md:block absolute top-20 left-10 w-3 h-3 rounded-full bg-primary" />
          <div className="absolute top-16 md:top-32 right-4 md:right-20 w-2 h-2 rounded-full bg-accent" />
          <div className="hidden md:block absolute bottom-32 left-20 w-2.5 h-2.5 rounded-full bg-primary" />
          <div className="absolute top-24 md:top-40 right-8 md:right-40 w-1.5 h-1.5 rounded-full bg-accent" />
          <div className="absolute bottom-20 md:bottom-40 right-6 md:right-16 w-2 h-2 rounded-full bg-primary" />
          <div className="hidden md:block absolute top-60 left-32 w-1.5 h-1.5 rounded-full bg-accent" />
        </div>
              ...
              return (
                ...
                >
                  <CardHeader className="pb-2 md:pb-3 relative z-10">
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-primary flex items-center justify-center mb-2 md:mb-3 group-hover:scale-110 transition-all duration-300 shadow-glow">
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {dbSkills.slice(0, 4).map((skill) => (
                  ...
                  >
                    <CardHeader className="pb-2 md:pb-3 relative z-10">
                      <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-accent flex items-center justify-center mb-2 md:mb-3 shadow-glow">
