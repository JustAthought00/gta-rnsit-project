    ...
    <div className="min-h-screen bg-background relative">
            ...
            <div className="hidden md:flex items-center flex-1 max-w-md mx-8 gap-2">
              <div className="relative w-full">
                ...
                <Input
                  ...
                  className="pl-10 bg-card border-2 border-foreground focus:border-primary"
                  value={searchTerm}
              ...
              <select
                ...
                className="text-xs bg-card border-2 border-foreground rounded-md px-2 py-2 text-muted-foreground focus:border-primary focus:outline-none"
              >
      ...
      <section className="py-8 md:py-16 px-4 relative overflow-hidden z-10">
        <div className="absolute inset-0 pointer-events-none">
          <div className="hidden md:block absolute top-20 left-10 w-12 h-12 rounded-lg bg-primary flex items-center justify-center animate-float-slow border-2 border-foreground shadow-glow">
            <Code className="h-6 w-6 text-primary-foreground" />
          </div>
          <div className="absolute top-16 md:top-32 right-4 md:right-20 w-8 md:w-10 h-8 md:h-10 rounded-lg bg-accent flex items-center justify-center animate-float-delayed border-2 border-foreground shadow-glow">
            <Camera className="h-4 md:h-5 w-4 md:w-5 text-accent-foreground" />
          </div>
          <div className="hidden md:block absolute bottom-32 left-20 w-14 h-14 rounded-lg bg-card flex items-center justify-center animate-float-reverse border-2 border-foreground shadow-glow">
            <PenTool className="h-7 w-7 text-foreground" />
          </div>
          <div className="absolute top-24 md:top-40 right-8 md:right-40 w-6 md:w-8 h-6 md:h-8 rounded-lg bg-primary flex items-center justify-center animate-float-slow border-2 border-foreground shadow-glow">
            <Palette className="h-3 md:h-4 w-3 md:w-4 text-primary-foreground" />
          </div>
          <div className="absolute bottom-20 md:bottom-40 right-6 md:right-16 w-9 md:w-11 h-9 md:h-11 rounded-lg bg-accent flex items-center justify-center animate-float-delayed border-2 border-foreground shadow-glow">
            <Video className="h-4 md:h-5 w-4 md:w-5 text-accent-foreground" />
          </div>
          <div className="hidden md:block absolute top-60 left-32 w-9 h-9 rounded-lg bg-card flex items-center justify-center animate-float-reverse border-2 border-foreground shadow-glow">
              ...
              return (
                ...
                >
                  <CardHeader className="pb-2 md:pb-3 relative z-10">
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-primary border-2 border-foreground flex items-center justify-center mb-2 md:mb-3 group-hover:scale-110 transition-all duration-300 shadow-glow">
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {dbSkills.slice(0, 4).map((skill) => (
                  ...
                  >
                    <CardHeader className="pb-2 md:pb-3 relative z-10">
                      <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-accent border-2 border-foreground flex items-center justify-center mb-2 md:mb-3 shadow-glow">
